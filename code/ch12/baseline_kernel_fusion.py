...
class BaselineKernelFusionBenchmark(BaseBenchmark):
    ...
    def get_custom_metrics(self) -> Optional[dict]:
        ...
        return {
            "kernel_fusion.num_iterations": float(getattr(self, 'iterations', 1) or getattr(self, 'num_iterations', 1)),
            "kernel_fusion.uses_graph": 0.0,  # 0=baseline (no graph), 1=optimized
        }
