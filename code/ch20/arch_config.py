...
_BLACKWELL_VARIANTS: List[ArchInfo] = [
    ArchInfo((10, 0), "compute_100", "sm_100"),  # B200
    ArchInfo((10, 3), "compute_103", "sm_103"),  # B300 (Blackwell Ultra)
]
...
def current_arch() -> ArchInfo:
    ...
    raise RuntimeError(
        f"Unsupported device capability SM{major}{minor}; expected Blackwell SM10x (B200/B300)"
    )
