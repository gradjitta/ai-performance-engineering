"""Benchmark harness wrapper for KV locality H2D microbench."""
...
class BaselineKvLocalityMicrobench(BaseBenchmark):
    """Runs the KV locality microbench under benchmark_cli."""
...
def get_benchmark() -> BaseBenchmark:
    return BaselineKvLocalityMicrobench()
