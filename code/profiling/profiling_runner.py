...
if TYPE_CHECKING:
    ...
    from profiling.metrics_extractor import NcuMetrics, NsysMetrics
else:
    NsysMetrics = Any
    NcuMetrics = Any
...
try:
    from profiling.metrics_extractor import extract_nsys_metrics, extract_ncu_metrics, extract_proton_metrics
    from profiling import profiler_config as _profiler_config
    from profiling.profiler_wrapper import create_benchmark_wrapper as _create_wrapper
