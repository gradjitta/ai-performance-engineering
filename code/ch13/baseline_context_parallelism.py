...
def get_benchmark() -> BaseBenchmark:
    ...
    def get_custom_metrics(self) -> Optional[dict]:
        ...
        return {
            "context_parallelism.batch_size": float(getattr(self, 'batch_size', 0)),
            "context_parallelism.hidden_dim": float(getattr(self, 'hidden_dim', 0)),
            "context_parallelism.precision_bits": 32.0,  # Override: 32=fp32, 16=fp16, 8=fp8, 4=fp4
        }
