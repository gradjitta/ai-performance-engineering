...
class OptimizedMatmulTCGen05EpilogueBenchmark(BaseBenchmark):
    ...
    def get_custom_metrics(self) -> Optional[dict]:
        ...
        return {
    "matmul_tcgen05_epilo.estimated_flops": flops,
    "matmul_tcgen05_epilo.estimated_bytes": bytes_moved,
    "matmul_tcgen05_epilo.arithmetic_intensity": arithmetic_intensity,
}
