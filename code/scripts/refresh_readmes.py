...
ENTRIES["README.md"] = Entry(
    ...
    contents=[
        ...
        ("`benchmark/`, `profiling/`, `core/`, `optimization/`, `analysis/`", "Shared harness, logging, workload metadata, profiling, and optimization utilities used by every chapter."),
    ...
    validation=[
        ...
        "`python benchmark/benchmark_peak.py` reports TFLOP/s, bandwidth, and NVLink numbers close to the published ceilings.",
